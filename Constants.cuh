...
namespace Constants {
	...
	constexpr double M_U238 = 238.0507826;
	constexpr double M_O16  = 15.9949146;
	constexpr double M_H1   = 1.0078250;
	constexpr double M_C12  = 12.0;
	constexpr double M_Neutron    = 1.008664916;
